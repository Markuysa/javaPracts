...
public class CardService {
    ...
    public void add(String cardNumber, int code, Long bankid) {
        Card card = new Card(cardNumber,code);
        card.bank.setID(bankid);
    ...
    public List<Card> getAll() {
        return session.createQuery("select a from Card a inner join Bank b on a.bank.id = b.id",
