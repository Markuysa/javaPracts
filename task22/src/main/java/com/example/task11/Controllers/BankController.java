...
public class BankController {
    ...
    @PostMapping("")
    @ResponseBody
    public void createCard(@RequestParam String name,@RequestParam String address) {bankService.add(name,address);}
    ...
    public List<String> getBanksNames() {
        return bankService.filterByName();
    }
    @GetMapping("/addresses")
    public List<String > getBanksAddresses() {
        return bankService.filterByAddress();
    }
